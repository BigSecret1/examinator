...
function useStartCTA() {
  ...
  // After sign-in, RootPage swaps to <Dashboard /> automatically — no redirect needed.
...
function HowItWorks() {
  const steps = [
    { n: "01", title: "Upload your PDF", body: "Drop in a textbook chapter, lecture slides, or a paper. Scanned PDFs work too." },
    { n: "02", title: "AI reads & structures it", body: "Examinator extracts sections, subtopics, key terms, and learning objectives." },
    { n: "03", title: "Study & remember", body: "Review structured notes, drill key terms, and quiz yourself with flashcards." },
  ];
  return (
